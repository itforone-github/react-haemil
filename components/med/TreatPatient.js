                                    ...
                                    <td colSpan="9">
                                        ...
                                        <table className="">
                                            ...
                                            <tr>
                                                ...
                                                <th className="" rowSpan="2">결제수단</th>
                                                <th className="" rowSpan="2">주문금액</th>
                                                <th className="" rowSpan="2">조제 지시서</th>
                                                <th className="" rowSpan="2">복용법</th>
                                                <th className="" rowSpan="2">관리</th>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td className="" rowSpan="2">현금결제</td>
                                                <td className="" rowSpan="2">119,400원</td>
                                                <td className="" rowSpan="2"><button type="button" className="btn btn_red btn_h40">확인</button></td>
                                                {/*최초발행 btn_blue 재발행 btn_red*/}
                                                <td className="" rowSpan="2">
                                                    <button type="button" className="btn btn_whiteline btn_h40">확인</button>
                                                </td>
                                                <td className="" rowSpan="2">
                                                    <button type="button" className="btn btn_whiteline" onClick="location.href='../med/px.prescribe5.view.php'">수정</button>
                                                    <button type="button" className="btn btn_redline">취소</button>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td className="" rowSpan="1">
                                                    <span className="state">주문접수</span>
                                                </td>
                                                <td className="" colSpan="1">
                                                    <span className="txt_blue txt_under">
                                                        <Link href={"/pxPrescribe1View"}>
                                                ...
                                                <td className="" rowSpan="2">119,400원</td>
                                                <td className="" rowSpan="2">
                                                    <button type="button" className="btn btn_red btn_h40">확인</button>
                                                </td>
                                                {/*최초발행 btn_blue 재발행 btn_red*/}
                                                <td className="" rowSpan="2"><button type="button" className="btn btn_whiteline btn_h40">확인</button></td>
                                                <td className="" rowSpan="2">
                                                    <button type="button" className="btn btn_whiteline" onClick="location.href='../med/px.prescribe5.view.php'">수정</button>
                                                    <button type="button" className="btn btn_redline">취소</button>
                                                </td>
